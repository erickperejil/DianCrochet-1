    ...
    <div className="flex h-full w-[100%] items-center">
      ...
      <div className="relative h-full w-full">
        <input
          type="text"
          id="numero"
          className="z-20 block h-full w-full rounded-e-lg rounded-md border border-s-0 border-none bg-gray-300 p-2.5 font-lekton text-gray-900  placeholder:font-lekton placeholder:text-gray-400 focus:outline-none"
          pattern="(\d{4}-\d{4}|\d{8})"
