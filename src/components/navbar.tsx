  ...
  return (
    <header className="bg-white shadow-md font-koulen">
      <div className="container mx-auto flex items-center justify-between py-2 px-6">
        ...
        {/* Search bar */}
        <div className="hidden md:flex items-center rounded-full px-4 py-1 w-1/3 bg-white focus:outline-none focus-visible:outline-none focus:ring-0 focus:border-none">
          <button title='buscar'>
            <FaSearch className="text-white bg-white" />
          </button>
        </div>
